...
int main (int argc, char **argv)
{
   ...
   int i; 				/* indice */
   int totale=0; 			/* serve per calcolare il numero di occorrenze: in questo caso abbiamo usato un semplice int perche' la specifica dice che si può supporre minore di 255 */
   int fd; 				/* per la open */
